...
/**
 * <p>Java class for TipoEquipoMedida.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="TipoEquipoMedida">
 ...
 * 
 */
@XmlType(name = "TipoEquipoMedida")
@XmlEnum
public enum TipoEquipoMedida {
    ...
    public static TipoEquipoMedida fromValue(String v) {
        for (TipoEquipoMedida c: TipoEquipoMedida.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
